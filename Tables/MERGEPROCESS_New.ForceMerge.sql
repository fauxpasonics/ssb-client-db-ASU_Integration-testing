...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__ForceMerg__Creat__2A164134] DEFAULT (getdate()),
[CreatedBy] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Complete] [bit] NULL CONSTRAINT [DF__ForceMerg__Compl__2B0A656D] DEFAULT ((0)),
