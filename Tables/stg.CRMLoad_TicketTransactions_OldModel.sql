CREATE TABLE [stg].[CRMLoad_TicketTransactions_OldModel]
(
...
GO
ALTER TABLE [stg].[CRMLoad_TicketTransactions_OldModel] ADD CONSTRAINT [PK_CRMLoad_TicketTransactions] PRIMARY KEY CLUSTERED  ([Order_Line_ID__c])
GO
